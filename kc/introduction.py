...
In the following, we investigate how investors can manage their exposure to climate risks, in the presence of strong uncertainty about the future evolution of the climate. 
We show how investors with different perceptions of climate risks can form their optimal portfolios. The combined perceptions of climate risks of all investors determine the level of the climate risks premium. We then show how we can reexpress the optimal portfolio weights in terms of allocation between the market portfolio and the climate risks hedging portfolio, with the latter being proportional to the stocks' sensitivity to climate risks, and the allocation being determined by the investor's perception of climate risks. We also show how unanticipated changes in climate risks perception may incur unexpected returns. Finally, we propose two simple strategies as an illustration of practical implications of the PST model.
...
[1]: De Nard, G., Engle, R. F., & Kelly, B. (2024). Factor-Mimicking Portfolios for Climate Risk. Financial Analysts Journal, 1-22.

[2]: Giglio, S., Kelly, B., & Stroebel, J. (2021). Climate finance. Annual review of financial economics, 13(1), 15-36.

[3]: Brock, W. A., & Hansen, L. P. (2018). Wrestling with uncertainty in climate economic models. University of Chicago, Becker Friedman Institute for Economics Working Paper, (2019-71).
            
[4]: Pástor, Ľ., Stambaugh, R. F., & Taylor, L. A. (2021). Sustainable investing in equilibrium. Journal of financial economics, 142(2), 550-571.
""")
