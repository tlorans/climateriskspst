...
st.title('Theory of Climate Risks and Unexpected Returns')
...
st.image('climate_risks_unexpected_returns/images_tick-1.png', caption='One-Period Overlapping Generation Model')
...
st.subheader('Discount Rate Shock')

st.write(r"""
         extend with discount rate shock)
            """)
