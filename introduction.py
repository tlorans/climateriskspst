...
As noted by Brock and Hansen (2018) [3], the climate change complexity makes it especially challenging to model, and adds ambiguity and model misspecification to the usual risk component of uncertainty.
